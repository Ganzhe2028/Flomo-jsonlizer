...
def test_memo_record_to_dict() -> None:
    ...
    d = memo.to_dict()
    assert d["memo_uid"] == "flomo-isaacbao-20260301--0255"
...
def test_image_record_to_dict() -> None:
    img = ImageRecord(
        ...
        source_relpath="2026/flomo@IsaacBao-20260301/file/2026-03-04/1198733/abc.png",
    )
    d = img.to_dict()
    assert d["image_uid"] == "flomo-isaacbao-20260301--0255--01"
...
def test_missing_image_record_to_dict() -> None:
    missing = MissingImageRecord(
        memo_uid="flomo-isaacbao-20260301--0255",
        image_uid="flomo-isaacbao-20260301--0255--02",
        source_relpath="2026/flomo@IsaacBao-20260301/file/2026-03-04/999/def.png",
